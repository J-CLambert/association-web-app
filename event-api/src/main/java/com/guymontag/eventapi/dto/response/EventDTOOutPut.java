...
public class EventDTOOutPut implements EventDTO {
    ...
    public EventDTOOutPut(Long id, String name, Instant startOfEvent, int duration, String description, EventStatus status, String location) {
        this.id = id;
        this.name = name;
